...
<center>__Обратить внимание на:__</center>
* _С чего начинается программа на Java_
* _Форматирование кода_
* _Сочетание клавиш для быстрого форматирования кода_
* _Быстрое изменение имени переменных (Refactor, Rename)_
* _Более простые решения_
* _Как оформляются методы_
