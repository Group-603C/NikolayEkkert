...
2) __Простое число__. Реализуйте метод для проверки числа на простоту. 

```java
boolean IsSimple(int number);
```

3) __Скобки__. Реализовать метод, который по заданной скобочной последовательности говорит, “правильная” ли она.
